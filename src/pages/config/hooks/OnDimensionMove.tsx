import { cblock } from '@/components/Code';
import HermesEditor from '@/components/HermesEditor';
import { Dimension } from 'hermes-parallel-coordinates';
...
`}
      ...
      <HermesEditor config={{
        hooks: {
          onDimensionMove: (dimension: Dimension, newIndex: number, oldIndex: number) => {
            /**
